...
<body>
                                ...
                                <div class="chat-content-reader">
                                    ...
                                    <div class="chat-content-reader-box">
                                        ...
                                        <div class="chat-content-reader-info">
                                            ...
                                            <span class="chat-content-reader-count chat-hide"></span>
                                        </div>
                                    </div>
                                    <!--聊天好友群聊模板-->
                            ...
                            <div class="chat-content-talk-body">
                                ...
                                <div class="chat-content-talk-box chat-content-talk-hide">
                                    ...
                                    <div class="chat-content-talk-text">
                                        <div class="clearFix">
                                            <div class="message">
                                                <img class="chat-content-talk-pic" src="#" alt="pic" />
                                                <div class="content">
                                                    <div class="bubble">
    ...
    <!--添加接受好友确认模态弹出框-->
    <div class="chat-modal" id="chatAccept">
        <div class="chat-modal-mask"></div>
        <div class="chat-modal-box">
            <div class="chat-modal-content">
                <div class="chat-modal-head">
                    <h4><span></span>请求添加好友</h4>
                    <span class="fa fa-close chat-modal-close"></span>
                </div>
                <div class="chat-modal-body">
                    <div>
                        <div class="chat-add-count">添加人账号</div>
                        <div class="chat-add-name">添加人昵称</div>
                    </div>
                </div>
                <div class="chat-modal-foot">
                    <a class="chat-modal-close">拒绝</a>
                    <a class="chat-modal-foot-save">接受</a>
                </div>
            </div>
        </div>
    </div>
